# Apunts M5074: Introducció, Gestió i Metodologies de la Ciència de Dades
...
* **Valor per als negocis**: Actiu valuós que permet optimitzar operacions, conèixer els clients, reduir costos, augmentar beneficis i innovar.
...
| --- | --- | --- | --- |
| **Data Analysis**<br> | Reactiu / Explicatiu

 | **Passat**: Examina, neteja i transforma dades per respondre preguntes específiques.

 | Analitzar les vendes passades d'entrades de cinema per trobar patrons de consum.

 |
| **Data Analytics**<br> | Proactiu / Predictiu

 | **Futur**: Aplica tècniques i processos per identificar tendències i fer prediccions contínues.

 | Utilitzar modelatge de dades per predir l'èxit de pel·lícules futures.

 |

---

### 1.3. Clasificació de les Dades
...
* *D'Interval*: Tenen una escala amb punts equidistants però **sense zero absolut** (ex. temperatura en °C o °F; $0^\circ\text{C}$ no vol dir "absència de temperatura").
...
### 3.3. Els 6 Pasos de la Metodologia del Curs
