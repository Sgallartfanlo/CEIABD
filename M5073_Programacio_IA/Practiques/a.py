# -*- coding: utf-8 -*-
"""Exercicis_sessio_1_i_2.ipynb


1. Taula de multiplicar. Demana un número al usuari i mostra la seva taula de multiplicar del 1 al 10.
"""
...
"""---
2. Suma dels primers N números. Demana un número **N** i calcula la suma dels primers **N** primers números naturals (enters).
...
"""---
3. Factorial d'un número. Demana un número enter positiu i calcula el seu factorial.
...
"""---
4. Seqüència de Fibonacci. Demana un número **N** i mostra els **N** primers termes de la seqüència Fibonacci.
...
"""5. Nombre primer. Demana un número enter i indica si és primer o no.
...
"""6. **Combinació extrema.** Crea una calculadora que permeti realitzar totes les operacions programades anteriorment. Per fer-ho...
   1. Mostra un menu on l'usuari seleccioni el tipus d'operació quevol realitzar
